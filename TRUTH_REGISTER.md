...
- **23 source modules** in the `src/rss/` package tree (subpackages: `core/`, `governance/seats/`, `audit/`, `hubs/`, `persistence/`, `llm/`) + `src/main.py` CLI entry point
...
- public docs are synchronized to the 152/1398 baseline as of this update; ROADMAP remains the working truth source going forward
