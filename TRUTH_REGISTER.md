...
- **139 test functions / 1187 assertions / 0 failures** via `python tests/test_all.py`
...
- public docs are synchronized to the 139/1187 baseline as of this update; ROADMAP remains the working truth source going forward
