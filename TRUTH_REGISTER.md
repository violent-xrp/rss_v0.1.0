...
- **139 test functions / 1182 assertions / 0 failures** via `python tests/test_all.py`
...
- public docs are synchronized to the 139/1182 baseline as of this update; ROADMAP remains the working truth source going forward
