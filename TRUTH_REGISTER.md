...
- `clear_safe_stop()` is T-0 only by convention and docstring, not by mechanical identity gate; the mechanical gate is Phase F work
- public docs are synchronized to the 131/994 baseline as of this update; ROADMAP is the working truth source going forward
