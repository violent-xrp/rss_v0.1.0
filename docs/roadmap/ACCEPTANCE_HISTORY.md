...
- **145 test functions / 1312 assertions / 0 failures**
- **92.2% statement coverage**
- **145 claims / 145 tests / 109 Pact sections**
...
All public-facing docs were synced to the current **145 / 1312 / 0** baseline on 2026-04-29:
- `README.md`
- `TRUTH_REGISTER.md`
- `CLAIM_DISCIPLINE.md`
- `CONTRIBUTING.md`
