...
- **140 test functions / 1217 assertions / 0 failures**
- **92.5% statement coverage**
- **140 claims / 140 tests / 103 Pact sections**
...
All public-facing docs were synced to the current **140 / 1217 / 0** baseline on 2026-04-29:
- `README.md`
- `TRUTH_REGISTER.md`
- `CLAIM_DISCIPLINE.md`
- `CONTRIBUTING.md`
