...
- **147 test functions / 1325 assertions / 0 failures**
- **91.7% statement coverage**
- **147 claims / 147 tests / 110 Pact sections**
...
All public-facing docs were synced to the current **147 / 1325 / 0** baseline on 2026-04-29:
- `README.md`
- `TRUTH_REGISTER.md`
- `CLAIM_DISCIPLINE.md`
- `CONTRIBUTING.md`
