...
Current code state:
- **164 test functions / 1517 assertions / 0 failures** via the custom acceptance runner (`python tests/test_all.py`)
...
- public docs are synced to the current 164/1517 baseline
