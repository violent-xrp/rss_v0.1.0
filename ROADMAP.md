...
complete architecture map. The later 2026-09-17 human direction permits necessary
structural and proof changes through the current DOCS-04 migration design;
queue placement itself remains scheduling, not implementation evidence.
...
| --- | --- | --- |
| BUILD-03-A | [Stable repository and proof contract](docs/SIGIL_CRUCIBLE.md#build-03-a--stable-repository-and-proof-contract) | Historical mapping/checkpoint evidence: repository, command, paths, registration and totals were preserved and independently checked. For future separation, the human amended the preservation constraint on 2026-09-17: necessary structural/proof changes and new measured totals follow the [proof-migration contract](docs/SIGIL_CRUCIBLE.md#docs-04-separation-outcomes-and-proof-migration). This amendment is documentation, not a new execution result. |
...
| BUILD-03-D | [Registration by name](docs/SIGIL_CRUCIBLE.md#build-03-d--registration-by-name) | Historical static membership: all 181 entries were independently reconciled by qualified name, with unique definitions and no omissions or duplicates. This is static membership evidence; no acceptance rerun. |
