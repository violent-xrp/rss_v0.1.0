...
Current code state:
- **164 test functions / 1513 assertions / 0 failures** via the custom acceptance runner (`python tests/test_all.py`)
...
- public docs are synced to the current 164/1513 baseline
