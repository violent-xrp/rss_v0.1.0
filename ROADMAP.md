...
Current code state:
- **152 test functions / 1398 assertions / 0 failures** via the custom acceptance runner (`python tests/test_all.py`)
...
- public docs are synced to the current 152/1398 baseline
