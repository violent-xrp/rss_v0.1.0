...
Current code state:
- **169 test functions / 1603 assertions / 0 failures** via the custom acceptance runner (`python tests/test_all.py`)
...
- public docs are synced to the current 169/1603 baseline
