...
**Verified baseline:** 162 test functions, 1490 assertions, 0 failures, 92.2% coverage. Traceability: 162 claims mapped to 162 tests across 114 Pact sections.
...
python tests/test_all.py
```
The acceptance run prints `RSS v0.1.0 - 162 test functions, 1490 assertions passed, 0 failed` as its final line.
