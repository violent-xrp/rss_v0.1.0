...
**Current verified project-snapshot baseline:** **139 test functions / 1182 assertions / 0 failures** via `python tests/test_all.py`.
...
```text
RSS v0.1.0 - 139 test functions, 1182 assertions passed, 0 failed
```
