...
**Verified baseline:** 147 test functions, 1325 assertions, 0 failures, 91.7% coverage. Traceability: 147 claims mapped to 147 tests across 110 Pact sections.
...
```
The acceptance run prints `RSS v0.1.0 - 147 test functions, 1325 assertions passed, 0 failed` as its final line.
