...
**Verified baseline:** 148 test functions, 1336 assertions, 0 failures, 91.7% coverage. Traceability: 148 claims mapped to 148 tests across 111 Pact sections.
...
```
The acceptance run prints `RSS v0.1.0 - 148 test functions, 1336 assertions passed, 0 failed` as its final line.
