...
**Verified baseline:** 174 test functions, 1671 assertions, 0 failures, 92.4% coverage. Traceability: 174 claims mapped to 174 tests across 118 Pact sections.
...
python tests/test_all.py
```
The acceptance run prints `RSS v0.1.0 - 174 test functions, 1671 assertions passed, 0 failed` as its final line.
