...
**Verified baseline:** 169 test functions, 1603 assertions, 0 failures, 92.3% coverage. Traceability: 169 claims mapped to 169 tests across 115 Pact sections.
...
python tests/test_all.py
```
The acceptance run prints `RSS v0.1.0 - 169 test functions, 1603 assertions passed, 0 failed` as its final line.
