...
**Verified baseline:** 157 test functions, 1433 assertions, 0 failures, 92.4% coverage. Traceability: 157 claims mapped to 157 tests across 113 Pact sections.
...
python tests/test_all.py
```
The acceptance run prints `RSS v0.1.0 - 157 test functions, 1433 assertions passed, 0 failed` as its final line.
