...
EVENT_CODES: Dict[str, Dict[str, str]] = {
    ...
    "ACTION_PROPOSED":       {"section": "S3", "category": "ACTION", "desc": "Structured action proposal received for broker review"},
    "ACTION_REJECTED":       {"section": "S3", "category": "ACTION", "desc": "Action proposal rejected by broker gate"},
    "ACTION_AUTHORIZED":     {"section": "S3", "category": "ACTION", "desc": "Action proposal authorized with single-use in-process receipt"},
    "ACTION_CLAIMED":        {"section": "S3", "category": "ACTION", "desc": "Action authorization receipt claimed before execution"},
    "ACTION_CLAIM_REFUSED":  {"section": "S3", "category": "ACTION", "desc": "Action authorization receipt refused at claim time"},
    "ACTION_REVOKED":        {"section": "S3", "category": "ACTION", "desc": "Action authorization receipt revoked before claim"},
    "ACTION_RESULT_IMPORTED": {"section": "S3", "category": "ACTION", "desc": "Action result imported as untrusted data-only evidence"},
    ...
    "OATH_PERSISTENCE_FAILURE": {"section": "S3", "category": "CONSENT", "desc": "Consent durability write failed (Phase D-6)"},
    "INGRESS_REJECTED":      {"section": "S5", "category": "CONTAINER", "desc": "Non-GLOBAL ingress without TECTON sentinel (Phase D-1)"},
