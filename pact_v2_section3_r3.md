...
As with Sections 1 and 2 (§1.0.1): unless otherwise noted, clauses define constitutional requirements. Implementation references describe the ERA-3 runtime and may evolve.
